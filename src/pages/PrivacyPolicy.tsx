        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-base leading-relaxed">
              Thank you for using Towlio ("we", "us", or "our"). We are
              committed to protecting your personal information and your right
              to privacy. This Privacy Policy explains what information we
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                such as your name, email address, and password when you register
                or log in.
              </li>
              <li>
                <span className="font-semibold">Usage Data:</span> information
                about how you use the application (e.g., task creation, project
                usage).
              </li>
              <li>
                <span className="font-semibold">Device Data:</span> IP address,
                browser type, operating system (used for analytics or
                debugging).
              </li>
            </ul>
            <p className="mt-2">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Communicate with you (e.g., notifications or support)</li>
          ...
          <div>
            ...
            <p className="mb-2">We may share your data only in these cases:</p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                With service providers who help us run the app (e.g., hosting or
                analytics)
              </li>
              <li>
                When required by law (e.g., legal requests, government
                authorities)
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              experience and analyze traffic. You can disable cookies through
              your browser settings.
            </p>
          </div>

          <div>
            <h3 className="text-2xl font-semibold mb-4">7. Security</h3>
            <p>
