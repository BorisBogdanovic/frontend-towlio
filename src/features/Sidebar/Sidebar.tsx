  ...
  return (
    <nav className="w-xs h-screen bg-white fixed py-8 px-4 flex flex-col justify-between shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] border-r border-r-disabledBorderGray">
      <div>
        ...
        <SidebarLink
          to="/inbox"
          icon={<HiChatBubbleLeftRight className="w-6 h-6 text-iconColor" />}
          label="Inbox"
        />
        <SidebarAccordion
        ...
        >
          <SidebarLink
            to="/create-client"
            icon={<HiOutlinePlusSmall className="w-6 h-6 text-iconColor" />}
            label="Create Client"
            nested
          />
          <SidebarLink
        ...
        {user?.is_admin && (
          <SidebarAccordion
            icon={<HiUserGroup className="w-6 h-6 text-iconColor" />}
            label="Salespeople"
          >
            <SidebarLink
              to="/create-user"
              icon={<HiUserPlus className="w-6 h-6 text-iconColor" />}
      ...
      <div>
        ...
        <SidebarLink
          to="/settings"
          icon={<HiMiniCog8Tooth className="w-6 h-6 text-iconColor" />}
          label="Settings"
        />
