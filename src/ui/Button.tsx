...
const buttonClasses: Record<NonNullable<ButtonProps["type"]>, string> = {
  ...
  delete:
    "text-sm w-full font-medium leading-5 bg-bdoRed text-white rounded-lg px-4 py-3 cursor-pointer hover:bg-bdoRedHover transition duration-300 ease",
  secondary:
  ...
  small:
    "h-[34px] w-[34px] text-sm flex items-center justify-center font-medium leading-5 bg-secondary text-textGray rounded-lg px-2.5 py-2.5 cursor-pointer hover:bg-secondaryHover transition duration-300 ease",
  refresh:
